...
const Login: React.FC = () => {
  ...
  const handleGuestAccess = () => {
    // For testing purposes, allow guest access
    navigate('/dashboard');
  };
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          <Link to="/" className="inline-block">
            <span className="text-4xl font-bold text-blue-600">🚀 ModelShip</span>
          </Link>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 placeholder-gray-400"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="block w-full pl-10 pr-10 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 placeholder-gray-400"
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <ul className="space-y-2 text-sm text-gray-600">
            <li className="flex items-center">
              ...
              AI-powered image & text classification
            </li>
            <li className="flex items-center">
              <span className="text-green-500 mr-2">✓</span>
